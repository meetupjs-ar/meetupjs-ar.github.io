...
var isna = void 0;
var audio = new Audio("" + '/assets/sounds/isnardi.mp3');
...
},{"mousetrap":2}],4:[function(require,module,exports){
'use strict';

var closeMenu = void 0;
var menu = void 0;
var openMenu = void 0;

function hightlightCurrentMenuItem() {
    var el = document.querySelector('#menu [href=\'' + window.location.pathname + '\']');
...
},{"./toast.js":8}],6:[function(require,module,exports){
'use strict';
...
},{"./toast.js":8}],8:[function(require,module,exports){
'use strict';
...
var easterEgg = require('./common/easter-egg');
...
},{"./common/easter-egg":3,"./common/menu":4,"./common/offline":5,"./common/safari-links":6,"./common/service-worker":7,"aload":1}]},{},[9]);
