...
const metatags = {
  ...
  title: `Reseña del Meetup.js de Julio 2019 - ${publicRuntimeConfig.REACT_APP_TITLE}`,
  url: `${publicRuntimeConfig.REACT_APP_URL}articulos/resena-meetup-julio-2019.html`,
};
...
export default () => (
  <>
    ...
    <PostPage name="resena-meetup-julio-2019" />
  </>
);
