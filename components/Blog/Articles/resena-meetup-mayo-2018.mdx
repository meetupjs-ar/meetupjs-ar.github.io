...
La charla completa de José la pueden ver a continuación.

<YouTube videoId="xA93dmkfcSQ" containerClassName="video-wrapper" className="video-iframe" />
...
La charla completa de Gabi la pueden ver a continuación.

<YouTube videoId="QtiDA8KkM3U" containerClassName="video-wrapper" className="video-iframe" />

### Álbum de fotos (Gracias [Có](https://twitter.com/co_constanza)!)

<PiolaSlider relativePath={'/static/Blog/resena-meetup-mayo-2018'} />
