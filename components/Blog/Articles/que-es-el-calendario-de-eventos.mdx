...
Por último, existe [esta página](http://meetupjs.com.ar/calendario) que solo hace uso de la API de _fetch_ para pedir los eventos agrupados y ordenados para mostrarlos.
