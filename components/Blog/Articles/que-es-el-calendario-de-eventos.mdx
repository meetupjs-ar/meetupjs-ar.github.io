export { metadata } from './que-es-el-calendario-de-eventos';
...
Por último, existe [esta página](https://meetupjs.com.ar/calendario) que solo hace uso de la API de _fetch_ para pedir los eventos agrupados y ordenados para mostrarlos.
